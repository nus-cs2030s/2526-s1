...
![control flow](../figures/exceptions/Exc.002.png){ width=450px }
...
![control flow](../figures/exceptions/Exc.003.png){ width=450px }
...
![control flow](../figures/exceptions/Exc.004.png){ width=450px }
